...
CREATE TABLE `b_commodity`  (
  ...
  `warehouseid` bigint NULL DEFAULT NULL COMMENT '所属仓库id',
  ...
  `validday` int NULL DEFAULT NULL COMMENT '有效天数',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `creatime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateid` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `b_stock`  (
  ...
  `locatorid` bigint NULL DEFAULT NULL COMMENT '货位id',
  ...
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  ...
  `cqty` int NULL DEFAULT NULL COMMENT '总数量',
  `uqty` int NULL DEFAULT NULL COMMENT '可用数量',
  `lqty` int NULL DEFAULT NULL COMMENT '锁定数量',
...
CREATE TABLE `b_stock_log`  (
  ...
  `createid` bigint NULL DEFAULT NULL COMMENT '创建者id',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateid` bigint NULL DEFAULT NULL COMMENT '修改者id',
  `updator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `updatetime` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `database_info` VALUES (1400845543558115330, 'master', 'com.mysql.cj.jdbc.Driver', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/wms?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2021-06-05 00:02:58');
...
CREATE TABLE `i_otherin`  (
  ...
  `updator` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '修改人',
  `updatetime` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `auditid` bigint NULL DEFAULT NULL COMMENT '审核人id',
...
CREATE TABLE `i_purchase`  (
  ...
  `supplierid` bigint NULL DEFAULT NULL COMMENT '供应商id',
  `suppliername` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '供应商名称',
  `commoditynum` int NULL DEFAULT NULL COMMENT '商品总数量',
  `estimatearrivaltime` datetime NULL DEFAULT NULL COMMENT '预计到货时间',
  `warehouseid` bigint NULL DEFAULT NULL COMMENT '仓库id',
...
CREATE TABLE `i_purchase_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '编号',
  `pid` bigint NULL DEFAULT NULL COMMENT '采购订单id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品编码',
  `commodityname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品名称',
  `qty` int NULL DEFAULT NULL COMMENT '数量',
...
CREATE TABLE `i_receive`  (
  ...
  `purchaseid` bigint NULL DEFAULT NULL COMMENT '采购单号id',
  `purchaseno` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '采购单号',
  `allocationid` bigint NULL DEFAULT NULL COMMENT '调拨id',
...
CREATE TABLE `i_receive_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '接货表id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
...
CREATE TABLE `i_warehousing_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '编号',
  `pid` bigint NULL DEFAULT NULL COMMENT '入库id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品编码',
  `commodityname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品名称',
  `qty` int NULL DEFAULT NULL COMMENT '数量',
...
-- ----------------------------
-- Records of i_warehousing_detail
-- ----------------------------
...
CREATE TABLE `o_otherout`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `warehouseid` bigint NULL DEFAULT NULL COMMENT '当前仓库id',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateid` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `o_outorder`  (
  ...
  `warehouseid` bigint NULL DEFAULT NULL COMMENT '仓库id',
  `category` int NULL DEFAULT NULL COMMENT '种类',
  `qty` int NULL DEFAULT NULL COMMENT '商品总数量',
  ...
  `depottime` datetime NULL DEFAULT NULL COMMENT '出库时间',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateid` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `o_outorder_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '出库表id',
  `stocklogid` bigint NULL DEFAULT NULL COMMENT '库存日志表id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编码',
...
CREATE TABLE `o_outorder_tag`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '主表id',
...
CREATE TABLE `o_pick`  (
  ...
  `picktaskid` bigint NULL DEFAULT NULL COMMENT '拣货任务id',
...
CREATE TABLE `o_pick_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '拣货id',
  `stocklogid` bigint NULL DEFAULT NULL COMMENT '库存日志id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编码',
  `commodityname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名',
  `locatorid` bigint NULL DEFAULT NULL COMMENT '货位id',
...
CREATE TABLE `o_picktask`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `picktaskno` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '拣货任务单号',
  `receiverid` bigint NULL DEFAULT NULL COMMENT '领取者id',
  `receiver` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '领取者',
  `receivetime` datetime NULL DEFAULT NULL COMMENT '领取时间',
  `warehouseid` bigint NULL DEFAULT NULL COMMENT '当前仓库id',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `o_picktask_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '主表id',
  `stockid` bigint NULL DEFAULT NULL COMMENT '库存id',
  `stocklogid` bigint NULL DEFAULT NULL COMMENT '库存日志id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编码',
  `commodityname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名称',
...
CREATE TABLE `o_picktask_lock_detail`  (
  ...
  `pid` bigint NULL DEFAULT NULL COMMENT '主表id',
  `picktaskno` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '拣货任务单号',
  `outorderid` bigint NULL DEFAULT NULL COMMENT '出库订单id',
  `outorderno` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '出库订单单号',
  `outorderdetailid` bigint NULL DEFAULT NULL COMMENT '出库订单明细id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编码',
  `commodityname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `locatorid` bigint NULL DEFAULT NULL COMMENT '货位id',
...
-- ----------------------------
-- Records of o_picktask_lock_detail
-- ----------------------------
...
CREATE TABLE `o_review_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `pid` bigint NULL DEFAULT NULL COMMENT '出库复核主表id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编码',
  `commodityname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名',
  `qty` int NULL DEFAULT NULL COMMENT '数量',
...
CREATE TABLE `oauth_user_info`  (
  ...
  `gender` int NULL DEFAULT NULL COMMENT '性别，1-男，0-女',
...
CREATE TABLE `s_allocation`  (
  ...
  `bwarehouseid` bigint NULL DEFAULT NULL COMMENT '原仓库id',
  `bwarehousename` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '原仓库名称',
  `awarehouseid` bigint NULL DEFAULT NULL COMMENT '目标仓库id',
...
CREATE TABLE `s_allocation_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '编号',
  `pid` bigint NULL DEFAULT NULL COMMENT '调拨id',
  `locatorid` bigint NULL DEFAULT NULL COMMENT '原货位id',
  `commodityid` bigint NULL DEFAULT NULL COMMENT '商品id',
  `commoditybar` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品编码',
  `commodityname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品名称',
  `qty` int NULL DEFAULT NULL COMMENT '数量',
  `lockstockid` bigint NULL DEFAULT NULL COMMENT '锁定库存的id',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateid` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
-- ----------------------------
-- Records of s_allocation_detail
-- ----------------------------
...
-- ----------------------------
-- Records of s_inventory_locator
-- ----------------------------
...
CREATE TABLE `s_inventory_locator_detail`  (
  ...
  `commoditybar` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品编码',
  `commodityname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '商品名称',
  `qty` int NULL DEFAULT NULL COMMENT '运单数量',
  `createid` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `creator` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建人',
  `createtime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of s_inventory_locator_detail
-- ----------------------------
...
-- ----------------------------
-- Records of s_inventory_locator_init
-- ----------------------------
...
CREATE TABLE `s_move`  (
  ...
  `locatorcode` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '货位编码',
  `locatorname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '货位名称',
  `oldlocatorid` bigint NULL DEFAULT NULL COMMENT '源货位id',
...
CREATE TABLE `s_puton`  (
  ...
  `locatorcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '货位编码',
  `locatorname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '货位名称',
  `oldlocatorid` bigint NULL DEFAULT NULL COMMENT '原货位id',
...
CREATE TABLE `sys_belong`  (
  `belong_id` bigint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sys_config` VALUES (1143468689664876546, '管理系统名称', 'TDT_SYSTEM_NAME', 'N', NULL, 'WMS仓储管理系统', '管理系统名称', '2019-06-25 18:39:15', 1, NULL, NULL);
...
INSERT INTO `sys_login_log` VALUES (1400842871438327810, '登录日志', 1, '2021-06-04 23:52:22', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1400843625561612289, '登录日志', 1, '2021-06-04 23:55:21', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1400845657160839170, '登录日志', 1, '2021-06-05 00:03:26', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1400846118932738049, '登录失败日志', NULL, '2021-06-05 00:05:16', '成功', '账号:admin,账号密码错误', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1400846147021991937, '登录日志', 1, '2021-06-05 00:05:23', '成功', NULL, '0:0:0:0:0:0:0:1');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (6, '欢迎', 'hi，WMS仓储管理系统发布了！', '2017-01-11 08:53:20', 1, '2018-12-28 23:24:48', 1);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, '1124606971782160385', 'admin', '1d6b1208c7d151d335790276a18e3d99', 'q6taw', '管理员', '2020-03-01 00:00:00', 'M', '123@qq.com', '18200000000', '1', 24, 'ENABLE', '2016-01-29 08:49:53', NULL, '2019-11-07 14:51:59', 24, 25);
